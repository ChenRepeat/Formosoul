...
const frames = ref([
  {
    id: 'night',
    text: "survivalguide.leftframetext",
    width: "280px",
    height: "250px",
    align: 'left',
    tag: 'p',
  ...
  {
    id: 'store',
    text: "survivalguide.rightframetext",
    width: '280px',
    height: '250px',
  }
])
...
.survival-heropics-left-case.img-is-active h4{
  font-size: 5.2rem;
}
