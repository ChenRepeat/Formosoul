<script setup>
import { ref } from 'vue';
import siteLogo from '@/assets/logo_black.svg'; 
...
.trigger-lang { color: $color-fsTitle; margin: 0; }
...
.header-icon { color: $color-fsTitle; font-size: 32px; cursor: pointer; }
...
.burger-list li a { color: $color-fsTitle; text-decoration: none; padding: 8px 12px; display: block; border-radius: 4px; transition: background-color 0.3s; }
...
/* 漢堡按鈕 */
.bar { background-color: $color-fsTitle; border-radius: 8px; }
